...
class AndroidMerchNewTasks extends StatefulWidget {
  final String merchandiser;
  const AndroidMerchNewTasks({Key? key, required this.merchandiser}) : super(key: key);

  @override
  State<AndroidMerchNewTasks> createState() => _AndroidMerchNewTasksState();
}

class _AndroidMerchNewTasksState extends State<AndroidMerchNewTasks> {
 ...
 /////
  ...
  Stream<List<NewAllTask>> readAllTask(String title,) =>
      FirebaseFirestore.instance
       ...
       .where("date",isGreaterThanOrEqualTo:DateTime.parse(
