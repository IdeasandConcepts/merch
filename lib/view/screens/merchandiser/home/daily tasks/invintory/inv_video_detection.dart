...
class InventoryVideoDetection extends StatefulWidget {
  ...
  @override
  State<InventoryVideoDetection> createState() => _InventoryVideoDetectionState();

// List<Map<String, dynamic>> Allresult = [];
}

class _InventoryVideoDetectionState extends State<InventoryVideoDetection> {
...
//    var ascading = resJson..sort();
    ...
    print(inventoryTaskDetails.length);
      ...
      snapshot.docs.forEach((element) {
        FirebaseFirestore.instance
          ...
          //  for (int k = 0; k < data.length; k++)
            ...
            if (data['id'] == (id)) {
              setState(() {
                inventoryTaskDetails.add(InventoryProduct(
