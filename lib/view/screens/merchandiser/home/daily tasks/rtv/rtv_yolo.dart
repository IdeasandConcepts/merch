...
class RTVVideoDetection extends StatefulWidget {
  ...
  final String marketImage,
      ...
      market,
      nationality;
  final String place, category,orderBy,taskType;
  const RTVVideoDetection(
      {super.key,
  ...
  @override
  State<RTVVideoDetection> createState() => _RTVVideoDetectionState();

// List<Map<String, dynamic>> Allresult = [];
}

class _RTVVideoDetectionState extends State<RTVVideoDetection> {
